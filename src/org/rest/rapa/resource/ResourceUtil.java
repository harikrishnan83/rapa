...
public class ResourceUtil {
	...
	public static NameValuePair[] getNameValuePairs(Object o)
		...
		for (Method method : methods) {
			...
			if (methodName.contains("get") && !methodName.equals("getClass")) {
				...
				nameValuePairs[i++] = new NameValuePair(clazz.getName()
						.substring(clazz.getName().lastIndexOf(".") + 1)
						.toLowerCase()
						+ "["
						+ methodName.substring(methodName.indexOf("t") + 1)
								.toLowerCase() + "]", value == null ? null
						: value.toString());
			}
		}
